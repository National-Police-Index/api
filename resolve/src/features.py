...
def normalize_features(df):
    ...
    # Wrap result in DataFrame to preserve column names for XGBoost
    scaled_values = TRAINED_SCALER.transform(df[features_to_scale])
    df[features_to_scale] = pd.DataFrame(
        scaled_values,
